...
-- Copiando dados para a tabela aula_1.alunos: ~3 rows (aproximadamente)
/*!40000 ALTER TABLE `alunos` DISABLE KEYS */;
INSERT INTO `alunos` (`id`, `nome`, `contato`, `sobrenome`) VALUES
	(1, 'FACEBOOKSON', '(19)99999-9988', 'FATEC'),
	(2, 'WEBSON', '(19)98719-9458', 'FATEC'),
	(3, 'MARIA DO BAIRRO', '(19)97711-1354', 'FATEC');
...
-- Copiando dados para a tabela aula_1.disciplinas: ~3 rows (aproximadamente)
